...
@login_required_decorator
def veterinary_drugs_update(request, pk):
...
@login_required_decorator
def veterinary_drugs_delete(request, pk):
    drug = get_object_or_404(VeterinaryDrugs, pk=pk)
    drug.delete()
    return redirect('veterinary_drugs_list')
